!function () {
    ...
    function g(e, t) {
        const i = p(new Date(e).setMonth(0, 1), t, t), s = p(e, t, t), n = m(s, i);
        if (n < 53) return n;
    ...
    const v = /dd?|DD?|mm?|MM?|yy?(?:yy)?/, x = /[\s!-/:-@[-`{-~年月日]+/;
    let M = {};
    const O = {
    ...
    function F(t) {
        ...
        const i = t.split(v), s = t.match(new RegExp(v, "g"));
    ...
    const R = new WeakMap, {addEventListener: j, removeEventListener: T} = EventTarget.prototype;
    ...
    function se(e, i) {
        const s = Object.assign({}, e), n = {}, a = i.constructor.locales, r = !!i.rangeSideIndex;
        let {
            datesDisabled: o,
            format: d,
            language: l,
        ...
        if (s.format) {
            const e = "function" == typeof s.format.toDisplay, t = "function" == typeof s.format.toValue,
                i = v.test(s.format);
    ...
    class le extends ce {
        ...
        updateFocus() {
            const e = new Date(this.picker.viewDate), t = e.getFullYear(), i = e.getMonth(), s = c(t, i, 1),
        ...
        render() {
            if (this.today = this.todayHighlight ? d() : void 0, this.prepareForRender(B(this.focused, this.switchLabelFormat, this.locale), this.first <= this.minDate, this.last >= this.maxDate), this.weekNumbers) {
                const e = this.weekStart, t = p(this.first, e, e);
            ...
            Array.from(this.grid.children).forEach(((e, t) => {
                const i = l(this.start, t), s = new Date(i), n = s.getDay(), a = [];
    ...
    class ue extends ce {
        ...
        updateSelection() {
            ...
            this.selected = e.reduce(((e, i) => {
                const s = new Date(i), n = s.getFullYear(), a = s.getMonth();
        ...
        render() {
            ...
            const e = this.selected[this.year] || [], t = this.year < this.minYear || this.year > this.maxYear,
                i = this.year === this.minYear, s = this.year === this.maxYear, n = he(this.range, this.year);
        ...
        refresh() {
            const e = this.selected[this.year] || [], t = he(this.range, this.year) || [];
    ...
    class fe extends ce {
        ...
        updateFocus() {
            const e = new Date(this.picker.viewDate), t = k(e, this.navStep), i = t + 9 * this.step;
        ...
        render() {
            this.prepareForRender(`${this.first}-${this.last}`, this.first <= this.minYear, this.last >= this.maxYear), Array.from(this.grid.children).forEach(((e, t) => {
                const i = this.start + t * this.step, s = b(new Date(i, 0, 1), 2, this.isRangeEnd);
    ...
    function me(e, t) {
        const {config: i, picker: s} = e, {currentView: a, viewDate: r} = s;
        let o;
        switch (a.id) {
            case 0:
                o = h(r, t);
    ...
    function Me(e, t) {
        ...
        const {id: s, isMinView: n} = e.picker.currentView, a = i.dataset;
    ...
    function Ve(e, t) {
        ...
        const {id: i, year: s, first: n, last: a} = e.currentView, r = new Date(t).getFullYear();
        switch (i) {
            case 0:
                return t < n || t > a;
            case 1:
    ...
    class Ae {
        constructor(e) {
            const {config: t, inputField: i} = this.datepicker = e, s = re.replace(/%buttonClass%/g, t.buttonClass),
            ...
            n.classList.add(`datepicker-${m}`), Ce(this, t), this.viewDate = Fe(e), H(e, [[n, "mousedown", Oe], [r, "click", Me.bind(null, e)], [p.viewSwitch, "click", be.bind(null, e)], [p.prevButton, "click", ve.bind(null, e)], [p.nextButton, "click", xe.bind(null, e)], [p.todayButton, "click", ye.bind(null, e)], [p.clearButton, "click", ge.bind(null, e)]]), this.views = [new le(this), new ue(this), new fe(this, {
                id: 2,
                name: "years",
                cellClass: "year",
                step: 1
        ...
        show() {
            ...
            const {datepicker: e, element: t} = this, i = e.inputField;
            if (i) {
                const s = Be(i);
        ...
        place() {
            ...
            t.display = "block";
            const {width: i, height: s} = this.element.getBoundingClientRect(), n = this.element.offsetParent;
            t.display = "";
        ...
        render(e = !0) {
            const {currentView: t, datepicker: i, _oldView: s} = this, n = new Date(this._oldViewDate),
    ...
    function Ye(e, t, i) {
        const s = e.picker, n = s.currentView, a = n.step || 1;
        let r, o = s.viewDate;
        switch (n.id) {
            case 0:
                o = l(o, i ? 7 * t : t), r = l;
    ...
    function We(e, t) {
        const {config: i, picker: s, editMode: n} = e, a = s.active, {key: r, altKey: o, shiftKey: d} = t,
            c = t.ctrlKey || t.metaKey, l = () => {
                t.preventDefault(), t.stopPropagation()
            };
        if ("Tab" === r) return void De(e);
        if ("Enter" === r) {
            if (a) if (n) e.exitEditMode({update: !0, autohide: i.autohide}); else {
                const t = s.currentView;
                t.isMinView ? e.setDate(s.viewDate) : (s.changeView(t.id - 1).render(), l())
            } else e.update();
            return
        }
        const h = i.shortcutKeys, u = {key: r, ctrlOrMetaKey: c, altKey: o, shiftKey: d},
    ...
    function $e(e, t, i = !1) {
        ...
        const {config: n, dates: a, rangeSideIndex: r} = e, {pickLevel: o, maxNumberOfDates: d} = n;
        let c = t.reduce(((e, t) => {
    ...
    class Ue {
        constructor(e, t = {}, s = void 0) {
            ...
            if ("INPUT" === e.tagName ? (a = this.inputField = e, a.classList.add("datepicker-input"), t.container && (n.container = t.container instanceof HTMLElement ? t.container : document.querySelector(t.container))) : n.container = e, s) {
                const e = s.inputs.indexOf(a), t = s.datepickers;
            ...
            this._options = t, Object.assign(n, se(t, this)), n.shortcutKeys = function (e) {
                return Object.keys(ne).reduce(((t, i) => {
                    const s = void 0 === e[i] ? ne[i] : e[i], n = s && s.key;
            ...
            const c = this.picker = new Ae(this), l = [e, "keydown", We.bind(null, this)];
            a ? H(this, [l, [a, "focus", _e.bind(null, this)], [a, "mousedown", Ke.bind(null, this)], [a, "click", Re.bind(null, this)], [a, "paste", je.bind(null, this)], [document, "mousedown", Te.bind(null, this)], [window, "resize", c.place.bind(c)]]) : (H(this, [l]), this.show())
        }
        ...
        setFocusedDate(e, t = !1) {
            const {config: i, picker: s, active: n, rangeSideIndex: a} = this, r = i.pickLevel,
    ...
    function ze(e, t) {
        ...
        const s = e.datepickers, [n, a] = s, r = {render: !1}, o = e.inputs.indexOf(i), d = 0 === o ? 1 : 0,
            c = s[o].dates[0], l = s[d].dates[0];
    ...
    window.Datepicker = Ue, window.DateRangePicker = class {
        constructor(e, t = {}) {
            ...
            const s = ze.bind(null, this), n = qe(t), a = this.datepickers = [];
            i.forEach((e => {
                !function (e, t, i, s) {
                    H(e, [[i, "changeDate", t]]), new Ue(i, s, e)
                }(this, s, e, n)
            })), Object.freeze(a), Object.defineProperty(this, "dates", {get: () => a.map((e => e.dates[0]))}), a[0].dates.length > 0 ? ze(this, {target: i[0]}) : a[1].dates.length > 0 && ze(this, {target: i[1]})
        }
        ...
        setDates(e, t) {
            const {datepickers: [i, s], inputs: [n, a], dates: [r, o]} = this;
